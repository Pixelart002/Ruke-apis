...
# --- NEW: Broadcast Endpoint (for Advertisements) ---
...
def broadcast_notification(
    ...
    # NOTE: I have corrected the loop. Your 'user_collection' is synchronous (PyMongo),
    # so we use a standard 'for' loop, not 'async for'.
